...
class GATv2(torch.nn.Module):
    def __init__(self):
        ...
        self.conv1 = GATv2Conv(9,    128, heads=8, concat=True)   # → 1024
        self.conv2 = GATv2Conv(1024, 64,  heads=8, concat=True)   # → 512
        self.conv3 = GATv2Conv(512,  32,  heads=8, concat=False)  # → 32
...
def main():
    ...
    print(f"\n{'='*30}")
    print(f"Accuracy Gatv2 : {accuracy:.2f}%")
    print(f"F1 Score Gatv2 : {f1:.2f}%")
    print(f"\nRapport détaillé :")
