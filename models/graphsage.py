...
class Graphsage(torch.nn.Module):
    def __init__(self):
        ...
        # self.conv1 = SAGEConv(9, 64) # 3 features (intensité,x,y)
        # self.conv2 = SAGEConv(64, 32) # 64 → 32
        # Actuel : 3 couches
        self.conv1 = SAGEConv(9, 128)
...
def main():
    ...
    print(f"\n{'='*30}")
    print(f"Accuracy GraphSage : {accuracy:.2f}%")
    print(f"F1 Score GraphSage : {f1:.2f}%")
    print(f"\nRapport détaillé :")
